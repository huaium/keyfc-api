...
internal object ForumParser {
     ...
     */
    suspend fun parse(repoClient: RepoClient, id: String, cookies: List<Cookie> = emptyList()): Result<ForumPage> {
        return runCatching {
    ...
    suspend fun parse(repoClient: RepoClient, forum: Forum, cookies: List<Cookie> = emptyList()) =
