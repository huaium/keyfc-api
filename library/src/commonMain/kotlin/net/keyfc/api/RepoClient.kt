...
internal class RepoClient : AutoCloseable {
    ...
    suspend fun parseUrl(url: String, cookies: List<Cookie> = emptyList()): Document {
     ...
     */
    private suspend fun getResponse(url: String, cookies: List<Cookie> = emptyList()): HttpResponse {
     ...
     */
    private fun HttpRequestBuilder.addRawCookies(cookies: List<Cookie>) {
